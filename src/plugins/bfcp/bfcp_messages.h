...
typedef struct bfcp_overall_request_status {	/*     Help structure for OVERALL-REQUEST-STATUS */
	...
	bfcp_request_status *rs;		/*     REQUEST-STATUS, optional */
	bfcp_floor_request_status *fRS;			/*     FLOOR-REQUEST-STATUS optional */ // add by csk, Polycom has this option
	char *sInfo;				/*     STATUS-INFO, optional */
...
bfcp_floor_request_status *bfcp_new_floor_request_status(UINT16 fID, bfcp_request_status* rs, char *sInfo);
...
bfcp_overall_request_status *bfcp_new_overall_request_status(UINT16 frqID, UINT16 rs, UINT16 qp, bfcp_floor_request_status* fRS, char *sInfo);
...
/* BFCP over UDP */
bfcp_message *bfcp_build_message_FloorRequestStatusAck(bfcp_entity *entity, bfcp_floor_id_list *fID); // modify by csk, add Parameter fID
bfcp_message *bfcp_build_message_ErrorAck(bfcp_entity *entity);
bfcp_message *bfcp_build_message_FloorStatusAck(bfcp_entity *entity, bfcp_floor_id_list *fID); // modify by csk, add Parameter fID
